...
large datasets as it has no memory pressure.`,
  ...
  vapi-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  vapi-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  vapi-pp-cli export <resource> --format jsonl | jq '.id'`,
